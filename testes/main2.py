...
def reiniciar_jogo():
    global cobra, direcao, maça, cobra_inimiga
    cobra = [(largura // 2, altura // 2)]
    direcao = (0, 0)
    maça = (random.randint(0, largura - tamanho_celula) // tamanho_celula * tamanho_celula,
            random.randint(0, altura - tamanho_celula) // tamanho_celula * tamanho_celula)
...
while True:
    ...
    if nova_cabeca_inimiga in cobra:
        # Cobra inimiga colidiu com a sua cobra
        # Desenha a tela borrada
        tela.fill((200, 200, 200, 128))
        
        # Desenha o botão de reiniciar
        fonte = pygame.font.Font(None, 36)
        texto = fonte.render("Você perdeu! Clique para reiniciar.", True, (0, 0, 0))
        retangulo = texto.get_rect(center=(largura // 2, altura // 2))
        tela.blit(texto, retangulo)
        
        # Atualiza a tela
        pygame.display.flip()

        # Aguarda até que o botão do mouse seja pressionado para reiniciar o jogo
        reiniciado = False
        ...
        # Sua cobra colidiu com a cobra inimiga
        # Desenha a tela borrada
        tela.fill((200, 200, 200, 128))
        ...
        # Desenha a tela de jogo normalmente
        tela.fill(cor_fundo)
